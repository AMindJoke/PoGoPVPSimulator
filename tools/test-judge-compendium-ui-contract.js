...
includes('Fast Attacks · ${reference.fast.length}');
includes('Charged Attacks · ${reference.charged.length}');
...
includes('No stat-stage effect in the canonical attack data.');
