...
assert.deepEqual(Analysis.resultPresentation({ score: 501 }), { tone: "favorable", tier: "slight", symbol: "▲" });
assert.deepEqual(Analysis.resultPresentation({ score: 650 }), { tone: "favorable", tier: "slight", symbol: "▲" });
assert.deepEqual(Analysis.resultPresentation({ score: 651 }), { tone: "favorable", tier: "clear", symbol: "▲" });
assert.deepEqual(Analysis.resultPresentation({ score: 750 }), { tone: "favorable", tier: "clear", symbol: "▲" });
assert.deepEqual(Analysis.resultPresentation({ score: 751 }), { tone: "favorable", tier: "dominant", symbol: "▲" });
assert.deepEqual(Analysis.resultPresentation({ score: 500 }), { tone: "neutral", tier: "neutral", symbol: "◆" });
assert.deepEqual(Analysis.resultPresentation({ score: 499 }), { tone: "unfavorable", tier: "slight", symbol: "▼" });
assert.deepEqual(Analysis.resultPresentation({ score: 350 }), { tone: "unfavorable", tier: "slight", symbol: "▼" });
assert.deepEqual(Analysis.resultPresentation({ score: 349 }), { tone: "unfavorable", tier: "clear", symbol: "▼" });
assert.deepEqual(Analysis.resultPresentation({ score: 250 }), { tone: "unfavorable", tier: "clear", symbol: "▼" });
assert.deepEqual(Analysis.resultPresentation({ score: 249 }), { tone: "unfavorable", tier: "dominant", symbol: "▼" });
