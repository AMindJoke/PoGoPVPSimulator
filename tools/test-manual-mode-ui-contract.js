...
assert.match(html, /src\/battle\/battle-intelligence\.js\?v=20260907-planner-v40/, "The page must load the current battle planner version instead of reusing a stale browser-cached script.");
