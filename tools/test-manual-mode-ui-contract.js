...
assert.match(html, /width: min\(1600px, calc\(100vw - 24px\)\)/);
...
assert.match(html, /manualBattleStateSegmented\(side, "attackStage"/);
assert.match(html, /manualBattleStateSegmented\(side, "defenseStage"/);
assert.match(html, /manualBattleStateShieldControl\(side, state\.shields\)/);
...
assert.match(html, /class="shield-count-toggle manual-state-shield-toggle"/);
assert.match(html, /data-manual-state-shields/);
assert.match(html, /const buttons = \[0, 1, 2\]\.map\(value/);
assert.match(html, /active: value === count/);
assert.match(html, /grid-template-columns: repeat\(3, minmax\(0, 1fr\)\);/);
assert.doesNotMatch(html, /active: slot <= count/);
assert.match(html, /aria-label="Pokemon \$\{side\}: \$\{count\} shields remaining"/);
...
assert.match(html, /field === "shields" \? String\(value\)/);
