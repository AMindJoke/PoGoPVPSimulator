...
const simple = IO.serializeScenario({
  ...
  runtimeState: {
    ...
    manualBattleTiming: { canonicalTurn: 2, chargedSequenceMs: 10000, elapsedBattleMs: 11000, nextSwitchAvailableAtMs: { A: 45000, B: 0 }, postChargedSwitchWindow: { turn: 2, sourceEventId: "charge-1", chargedAttackActor: "B", eligibleSides: ["B"] } },
