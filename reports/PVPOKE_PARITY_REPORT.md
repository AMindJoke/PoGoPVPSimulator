...
fallback usage in the supported parity corpus is 0/640 (0%).

## First-decision corpus

The pinned fixture corpus contains 600 action states and 40 shield states. It
...
| Tactical / immediate / forced | 80 | 80 | 100% |
| Timing | 40 | 40 | 100% |
| Farm / farm-down | 80 | 80 | 100% |
| Shield / no shield | 60 | 60 | 100% |
| Bait | 40 | 40 | 100% |
| Guaranteed and self effects | 120 | 120 | 100% |
| Move/route ordering | 80 | 80 | 100% |
| Long match | 160 | 160 | 100% |
| Entire corpus | 640 | 640 | 100% |

These category buckets are a reporting partition of the fixture families. The
permanent report lives in `reports/pvpoke-first-decision-parity/` and is
regenerated by `npm run test:pvpoke-first-decision-parity`.
The large corpus covers battle start, mid-battle, end game, HP and energy
leads, shield differences, CMP win/loss, equal and different Fast durations,
bait settings, buffs/debuffs, self-debuffing moves, farm-downs, immediate
lethal, forced throws, long-match shortcuts, protection mechanics, pending Fast
damage and queued Fast impacts.
