(function (root, factory) {
  ...
  const CURRICULUM = Object.freeze([
    ...
    Object.freeze({ id: "cap", order: 4, title: "Charged Attack Priority (CAP)", summary: "Resolve simultaneous Charged Attacks using priority Attack.", targetType: "mechanics", targetId: "charged-move-priority" }),
